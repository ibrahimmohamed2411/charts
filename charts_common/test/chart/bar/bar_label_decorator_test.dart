...
//   @override
//   TextElement createTextElement(String text, TextDirection direction) => FakeTextElement(text, direction);
...
//   FakeTextElement(this.text, this.textDirection);
...
//       {required this.measureFn, required this.index}) {
...
//       );
//       final captured = verify(canvas.drawText(barElements.first._series.));
